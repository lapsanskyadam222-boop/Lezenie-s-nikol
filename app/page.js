...
export default function Page() {
  ...
  const [date, setDate] = useState(formatDate(today)); // yyyy-mm-dd
  ...
  // načítaj rezervácie z localStorage (demo verzia bez servera)
  useEffect(() => {
    try {
  ...
  // ktoré časy sú už obsadené v zvolenom dni
  ...
  return (
    <main style={{ maxWidth: 900, margin: "0 auto", padding: 24 }}>
      ...
      >
        ...
        <a href="#rezervacia" style={{ marginLeft: 16, color: "#2563eb" }}>
          Rezervácia
        </a>
      </header>
      ...
      >
        <iframe
          title="PDF – Lezenie s Nikol"
          src="/LEZENIE-S-NIKOL-WEB-bez-konca.pdf"
          style={{ width: "100%", height: "70vh", border: 0 }}
        />
      </section>

      {/* REZERVÁCIA – AŽ POD PDF (používateľ k nej dôjde po scrolle) */}
      <h2 id="rezervacia" style={{ marginTop: 32 }}>Rezervácia stretnutia</h2>
      <p style={{ color: "#6b7280", fontSize: 14 }}>
        Vyberte dátum (iba aktuálny mesiac) a čas, potom zadajte meno a
        telefónne číslo.
      </p>
...
/* pomocná funkcia na formát dátumu yyyy-mm-dd */
